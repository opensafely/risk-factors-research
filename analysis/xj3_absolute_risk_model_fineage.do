********************************************************************************
*
*	Do-file:		xj3_absolute_risk_model_fineage.do
*
...
* Open a log file
capture log close
log using "./output/xj3_absolute_risk_model_fineage_`ethnicity'", text replace
...
* Save data
save "output/abs_risks_fineage_`ethnicity'", replace
