********************************************************************************
*
*	Do-file:		xj5_absolute_risk_model_fineage_group.do
*
...
* Open a log file
capture log close
log using "./output/xj5_absolute_risk_model_fineage_group", text replace
...
* Save data
save "output/abs_risks_fineage_group", replace
