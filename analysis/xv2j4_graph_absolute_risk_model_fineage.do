********************************************************************************
*
*	Do-file:		xv2j4_graph_absolute_risk_model_fineage.do
*
...
graph export output/abs_risk_resp_eth`ethnicity'_`outcome'.svg, as(svg) replace width(1600)
...
graph export output/abs_risk_cardiac_eth`ethnicity'_`outcome'.svg, as(svg) replace width(1600)
...
graph export output/abs_risk_organ_eth`ethnicity'_`outcome'.svg, as(svg) replace width(1600)
...
graph export output/abs_risk_stroke_eth`ethnicity'_`outcome'.svg, as(svg) replace width(1600)
...
graph export output/abs_risk_cancer_eth`ethnicity'_`outcome'.svg, as(svg) replace width(1600)
